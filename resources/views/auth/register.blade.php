    ...
    <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
                    <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('_addregister') }}">
                            @csrf
                        ...
                        <div class="wrap-input100 validate-input m-b-36" data-validate = "Username is required">
                            <input class="input100{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" type="text" name="name" value="{{ old('name') }}" required autofocus>
                             @if ($errors->has('name'))
                        ...
                        <div class="wrap-input100 validate-input m-b-36" data-validate = " Alamat is required">
                            <input class="input100" id="alamat" type="text" name="alamat" required autofocus>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-36" data-validate = "Postal Code is required">
                            <input class="input100" id="postal" type="text" name="postal_code" required autofocus>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-36" data-validate = "Phone is required">
                            <input class="input100" id="phone" type="text" name="phone" required autofocus>
                            <span class="focus-input100"></span>
                        </div>
