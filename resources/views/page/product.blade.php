                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">UD. Tumbuh Jati</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="index.html">Home</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">{{ $detail->name }}</span>
                            </nav>
                        </div>
                    </div>
                </div>
        						...
        						<div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
	        							<div class="fotorama wn__fotorama__action" data-nav="thumbs">
		        							  <a href="1.jpg"><img src="{{ asset('produk/'. $detail->image) }}" alt=""></a>
		        							  <a href="2.jpg"><img src="{{ asset('produk/'. $detail->image) }}" alt=""></a>
        			...
        			<div class="col-lg-3 col-12 md-mt-40 sm-mt-40">
        				<div class="shop__sidebar">
        					...
        					<aside class="wedget__categories sidebar--banner">
								<img src="{{ asset('main/images/others/banner_left.jpg') }}" alt="banner images">
								<div class="text">
									<h2>new products</h2>
